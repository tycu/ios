...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "Pods-Tally/ActionSheetPicker_3_0.framework"
  ...
  install_framework "Pods-Tally/JTSImageViewController.framework"
  install_framework "Pods-Tally/Mixpanel.framework"
  install_framework "Pods-Tally/SDWebImage.framework"
  install_framework "Pods-Tally/SSKeychain.framework"
  install_framework "Pods-Tally/Stripe.framework"
